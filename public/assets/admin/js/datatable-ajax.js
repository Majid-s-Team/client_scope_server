var ajaxDatatable = (element,source_url = '') => {
    ...
    table = $(element).DataTable({
        ...
        "searching": false,
        "deferRender": true,
        "responsive": true, // Added for responsive behavior
        "autoWidth": false, // Added to ensure full width
        "fixedHeader": true, // Added to help with scrolling,
        fixedColumns: {
                left: 1  // Fix the first column (checkbox column)
            },
        "ajax":{
            url: source_url,
            type: "POST", 
