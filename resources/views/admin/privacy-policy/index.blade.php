	...
	<div id="content" class="p-4">
        <div class="row">
            <div class="col-12">
                <div class="faq-title">
                    <div class="title">
                        <h4 class="heading2 font-30 color-f58719">Terms & Conditions</h4>
                    </div>
                    <div class="input">
