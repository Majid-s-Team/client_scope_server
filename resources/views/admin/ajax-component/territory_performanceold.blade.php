@if( count($territoryData) )
    @foreach( $territoryData as $territory_name => $results)
        ...
        <div class="row territory_container">
            <div class="col-12 col-md-12 col-lg-6  col-xl-6 mb-3" id="territory_kpi_group_datatable">
            ...
            @php
                extract($kpi_groups);
            @endphp
            <div class="col-12 col-md-12 col-lg-6  col-xl-6 mb-3" id="territory_metric_data_table">
                <div class="filter-box-2">
                    <p class="font-semi-bold font-18 color-black">{{ $territory_name }}</p>
                    <div class="table-container">
                        <table class="table">
            ...
            <div class="col-12 col-md-12 col-lg-6  col-xl-6 mb-3" id="territory_kpi_group_bar_chart">
                <div class="filter-box-2" >
                    <p class="font-semi-bold font-18 color-black">{{ $territory_name }}</p>
                    <div class="table-container">
                        <table class="table">
                                        ...
                                        <tr>
                                            <td>
                                                @if( !empty($kpiTarget->status_image_url) )
                                                    <img class="" src="{{ asset('assets/images/icon-'.basename($kpiTarget->status_image_url)) }}" alt="{{ get_user()->name }}">
                                                    <!-- <span class="fa fa-map-marker "></span> -->
                                                @else
                                                    <img class="" src="{{ asset('assets/images/map-icon.png') }}" alt="{{ get_user()->name }}">
                                                    <!-- <span class="fa fa-map-marker "></span> -->
            ...
            <div class="col-12 col-md-12 col-lg-6  col-xl-6 " id="territory_metric_bar_chart">
                <div class="filter-box-2">
                    <p class="font-semi-bold font-18 color-black">{{ $territory_name }}</p>
                    <div class="table-container">
                        <table class="table">
