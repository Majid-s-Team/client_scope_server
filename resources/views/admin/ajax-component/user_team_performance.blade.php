@if( count($teamPerformanceData) )
    @foreach( $teamPerformanceData as $team_name => $results)
        ...
        <div class="row territory_container">
            <div class="col-md-12 col-xl-6 mb-3" id="territory_kpi_group_datatable">
                    ...
                    <div class="table-container">
                        <table class="table">
                            ...
                            @foreach( $results['kpi_group_chart'] as $team_data )
                                ...
                                <tr>
                                    <td colspan="2">
                                    <img class="" src="{{ URL::to('assets/images/icon-'.basename($team_data->image_url)) }}" alt="{{ get_user()->name }}">
            ...
            @php
                extract($kpi_groups);
            @endphp
            <div class="col-md-12 col-xl-6 mb-3" id="territory_metric_data_table">
                <div class="filter-box-2" >
                    <p class="text-uppercase ft-14">{{ $team_name }}</p>
                    <div class="table-container">
                        <table class="table">
                            ...
                            @if( count($results['matric_chart']) )
                                @foreach( $results['matric_chart'] as $metric )
                                    <tr>
                                        <td colspan="2">
                                        <img class="" src="{{ asset('assets/images/map-icon.png') }}" alt="{{ get_user()->name }}">
                                            <!-- <span class="fa fa-map-marker "></span>  -->
            ...
            <div class="col-md-12 col-xl-6 mb-3" id="territory_kpi_group_bar_chart">
                <div class="filter-box-2" >
                    <p class="text-uppercase ft-14">{{ $team_name }}</p>
                    <div class="table-container">
                        <table class="table">
                                        ...
                                        <tr>
                                            <td>
                                                @if( !empty($kpiTarget->image_url) )
                                                    <!-- <span class="fa fa-map-marker "></span> -->
                                                    <img class="" src="{{ asset('assets/images/icon-'.basename($kpiTarget->image_url)) }}" alt="{{ get_user()->name }}">
                                                @else
                                                <img class="" src="{{ asset('assets/images/map-icon.png') }}" alt="{{ get_user()->name }}">
                                                    <!-- <span class="fa fa-map-marker "></span> -->
                                                @endif    
            ...
            <div class="col-md-12 col-xl-6 " id="territory_metric_bar_chart">
                <div class="filter-box-2" >
                    <p class="text-uppercase ft-14">{{ $team_name }}</p>
                    <div class="table-container">
                        <table class="table">
