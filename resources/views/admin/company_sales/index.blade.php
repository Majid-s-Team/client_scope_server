...
<section class="content-area">
   <div id="content" class="">
      <div class="row pb-3">
         <div class="col-md-12">
            <h4 class="font-24">Company Sales Plan</h4>
         </div>
         <form id="company_sales_form" method="post" action="">
            ...
            <div class="col-md-12">
               @include('admin.flash-message')
                  ...
                  <div class="row mt-3">
                     <div class="col-md-12">
                        <h4 class="font-24 mb-3">Company Sales Targets</h4>
                     </div>
                     <div class="col-md-8">
                        <div class="row new-modal">
                           <div class="col-md-4">
                              <label class="color-light mb-1">Company Annual Sales Target ($)</label>
                              <div class="input-group mb-3">
                                 <input type="text" required id="company_annual_sales_target" value="{{ !empty($companySalePlan->company_annual_sales_target) ? round($companySalePlan->company_annual_sales_target) : '' }}" name="company_annual_sales_target" class="form-control form-control2 money" placeholder="Company Annual Sales Target" autocomplete="off">
                           ...
                           <div class="col-md-4">
                              <label class="color-light mb-1">Company Year To Date Sold ($)</label>
                              <div class="input-group mb-3">
                                 <input type="text" required id="company_year_to_date_sold" value="{{ !empty($companySalePlan->company_year_to_date_sold) ? round($companySalePlan->company_year_to_date_sold) : '' }}" name="company_year_to_date_sold" class="form-control form-control2 money" placeholder="Company Year To Date Sold" autocomplete="off">
                                 <!-- <div class="input-group-append">
                                    <span class="input-group-text" >$</span>
                                 </div> -->
                              </div>
                           ...
                           <div class="col-md-4">
                              <label class="color-light mb-1">Left To Sell ($)</label>
                              <div class="input-group mb-3">
                     ...
                     <div class="col-md-4 calculation">
                        <div class="form-group">
                           <label class="color-light mb-1">Company Sales Needed Per Week ($)</label>
                  ...
                  <div class="row">
                     <div class="col-md-8">
                           <div class="row new-modal">
                           <div class="col-md-4">
                              <label class="color-light mb-1">Company Average Revenue Per Sale ($)</label>
                              <div class="input-group mb-3">
                                 <input type="text" required id="company_average_revenue_per_sale" value="{{ !empty($companySalePlan->company_average_revenue_per_sale) ? round($companySalePlan->company_average_revenue_per_sale) : '' }}" name="company_average_revenue_per_sale" class="form-control form-control2 money" placeholder="Company Average Revenue Per Sale" autocomplete="off">
                                 <!-- <div class="input-group-append">
                                    <span class="input-group-text" >$</span>
                                 </div> -->
                              </div>
                           ...
                           <div class="col-md-4">
                              <label class="color-light mb-1">Work Weeks Left For The Year</label>
                              <div class="input-group mb-3">
                           ...
                           <div class="col-md-4">
                              <label class="color-light mb-1">Work Months Left For The Year</label>
                              <div class="input-group mb-3">
                     ...
                     <div class="col-md-4 calculation">
                     <div class="form-group">
                           <label class="color-light mb-1">Company Sales Needed Per Month ($)</label>
                  ...
                  <div class="row mt-3">
                     <div class="col-md-12">
                        <h4 class=" font-24 mb-3">Company Staffing Plan</h4>
                     </div>
                     <div class="col-md-8">
                        <div class="row new-modal ">
                           <div class="col-md-4">
                              <label class="color-light mb-1">Active Company Sales Rep</label>
                              <div class="input-group mb-3">
                           ...
                           <div class="col-md-4">
                              <label class="color-light mb-1">Average Annual Sales Per Sales Rep</label>
                              <div class="input-group mb-3">
                                 <input type="text" required id="average_annual_sales_per_sales_reps" value="{{ !empty($companySalePlan->average_annual_sales_per_sales_reps) ? round($companySalePlan->average_annual_sales_per_sales_reps) : '' }}" name="average_annual_sales_per_sales_reps" class="form-control form-control2 money" placeholder="Average Annual Sales Per Sales Rep" autocomplete="off">
                                 <div class="input-group-append">
                                    <span class="input-group-text" >$</span>
                                 </div>
                              </div>
                           ...
                           <div class="col-md-4">
                              <label class="color-light mb-1">New Hire Retention Rate</label>
                              <div class="input-group mb-3">
                     ...
                     <div class="col-md-4 calculation">
                        <div class="row">
                           <div class="col-md-6">
                              <div class="form-group">
                                 <label class="color-light mb-1">Total Sales Reps Needed</label>
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 <label class="color-light mb-1">New Hires Needed </label>
                  ...
                  <div class="row mt-3">
                     <div class="col-md-12">
                        <h4 class=" font-24 mb-3">Company Metric Targets</h4>
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-md-8">
                     ...
                     @if( count($metrices) )
                        @foreach( $metrices as $metric )
                           <div class="col-4  col-md-4 ">
                              <label class="color-light mb-1">{{ !empty($metric->custom_metric_title) ? $metric->custom_metric_title : $metric->title }} (%)</label>
                              <div class="input-group mb-3">
                  ...
                  <div class="row new-modal mt-3">
                     <div class="col-md-12">
                        <h4 class="font-24 mb-3">Total Company Wide KPI Targets To Hit Sales Target</h4>
                     </div>
                     @if( count($kpi_groups) )
                        @foreach($kpi_groups as $kpi_group)
                           <div class="form-group col-md-4">
                              <label class="color-light mb-1">{{ $kpi_group->title }}</label>
                  ...
                  <div class="row new-modal mt-3">
                     <div class="col-md-12">
                        <h4 class=" font-24 mb-3">Company KPI Annual Targets To Hit Sales Target <small class="ft-14 font-12 color-light">(per active rep from above)</small></h4>
                     </div>
                     @if( count($kpi_groups) )
                        @foreach($kpi_groups as $kpi_group)
                           <div class="form-group col-md-4">
                  ...
                  <div class="row new-modal mt-3">
                     <div class="col-md-12">
                        <h4 class=" font-24 mb-3">Company KPI Monthly Targets To Hit Sales Target <small class="ft-14 font-12 color-light">(per active rep from above)</small></h4>
                     </div>
                     @if( count($kpi_groups) )
                        @foreach($kpi_groups as $kpi_group)
                           <div class="form-group col-md-4">
                  ...
                  <div class="row new-modal mt-3">
                     <div class="col-md-12">
                        <h4 class=" font-24 mb-3">Company KPI Weekly Targets To Hit Sales Target <small class="ft-14 font-12 color-light">(per active rep from above)</small></h4>
                     </div>
                     @if( count($kpi_groups) )
                        @foreach($kpi_groups as $kpi_group)
                           <div class="form-group col-md-4">
                  ...
                  <div class="d-flex align-items-center justify-content-center">
                     <button type="submit" class="filter-btn-without-icon bg-orange mt-4">Confirm</button>
                  </div>
                     </div>
                  </div>
