   ...
   <div id="content" class="p-4">
      <div class="row pb-3">
         ...
         <div class="col-md-6 text-end">
            <a class="nav-link pull-right" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#addTeamModal"><button class="btn btn-black"><i class="fa fa-user-plus pr-2"></i> Add Team</button></a>
         </div>
      </div>
      <div class="row">
