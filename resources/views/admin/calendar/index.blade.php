...
<!-- <div class="wrapper d-flex align-items-stretch"> -->
   ...
   <div id="content" class="p-5">
      <div class="row  justify-content-between appoit-text">
         <div class="col-12">
               <div class="map-header">
                  <div>
                     <h2 class="font-30">Appointment</h2>
                  </div>
                  <div class="d-flex align-items-center">
                     <button class=" add-appoit _add_appointment btn-block map-filter-btn bg-orange" data-href="{{ route('admin.add-appointment') }}" data-target="#addAppointment">
                           <ul class="d-flex align-items-center justify-content-center">
                              <li class="me-2"><img src="{{ asset('assets/images/ic_event.png') }}" /></li>
					 ...
					 @if( count($users) )
					 	@foreach( $users as $companyUser )
							<div class="d-flex justify-content-between mb-2 align-items-center user-calendar-post border-bottom">
								...
								<div class="d-flex media align-items-center mb-1">
									<img
