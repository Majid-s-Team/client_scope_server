...
<div class="wrapper d-flex align-items-stretch">
   ...
   <div id="content" class="p-0 map-sec">
      <div id="map">
      </div>
         ...
         <div class="tab-content bg-white" id="pills-tabContent">
            ...
            <div class="tab-pane fade" id="pills-terr" role="tabpanel" aria-labelledby="pills-terr-tab">
               <form id="add_territory_form" method="post">
                  ...
                  <div class="col-12">
                     <a href="javascript:void(0)" id="_clear_territory" class="color-danger d-flex align-items-center justify-content-center mt-5 clear-filter">
               ...
               <div class="territory_list">
                  ...
                  @endif
                  <div class="form-group text-center mt-3">
                    <button type="button" id="territory_search_btn" class="btn btn-save btn-theme">Search</button>
                 </div>
               </div>
            </div>
         </div>
