            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group col-md-12">
                        <p class="font-18 color-4e5164 mb-2"> Assign to Pin</p>
                        <select name="user_pin_id" class="form-control select2">
                            ...
                            @if( count($pins) )
                                @foreach( $pins as $companyPin )
                                    <option value="{{ $companyPin->id }}">{{ $companyPin->house_address }} {{ !empty($companyPin->name) ? '- ( '.$companyPin->name.' )' : '' }}</option>
                                @endforeach
                            @endif
                        </select>
                    </div>
                    <div class="form-group col-md-12">
                        <p class="mt-2 font-20 color-4e5164 font-weight-bold mb-2">Appointment</p>
                    </div>
                    ...
                    <div class="form-group col-md-4">
                        <div class="input-group date id_0">
                            <input type="text" required name="start_datetime" class="form-control" placeholder="Start Date time" required/>
                    ...
                    <div class="form-group col-md-4">
                        <div class="input-group date id_0">
                            <input type="text" required name="end_datetime" class="form-control" placeholder="End Date time" required/>
                            <span class="input-group-addon calender-icon">
                                <i class="glyphicon glyphicon-calendar fa fa-calendar"></i>
                            </span>
                        </div>
