<div class="modal fade new-modal" id="addCompanyFAQ" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <form method="POST" enctype="multipart/form-data" action="{{ route('admin.save-faq') }}">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-12">
                        <label>Answer</label>
                        <textarea name="answer" value="" class="form-control" placeholder="Answer" required></textarea>
                    </div>
                </div>
            </div>
