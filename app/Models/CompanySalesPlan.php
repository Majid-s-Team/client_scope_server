...
class CompanySalesPlan extends Model
{
    ...
    protected $fillable = [
        'company_user_id',
        'company_annual_sales_target',
        'company_year_to_date_sold',
        'left_to_sell',
        'company_average_revenue_per_sale',
        'work_week_left_for_the_year',
        'work_month_left_for_the_year',
        'company_sales_needed_per_week',
        'company_sales_needed_per_month',
        'active_company_sales_rep',
        'average_annual_sales_per_sales_reps',
        'new_hire_rentention_rate',
        'total_sales_reps_needed',
        'new_hire_needed',
        'created_at',
        'updated_at',
        'deleted_at'
    ...
    */
    ...
    public static function saveCompanyPlan($params)
    {
        ...
        $record = self::create([
            ...
            'company_annual_sales_target' => clean_number($params['company_annual_sales_target']),
            'company_year_to_date_sold' => clean_number($params['company_year_to_date_sold']),
            'left_to_sell' => clean_number($params['left_to_sell']),
            'company_average_revenue_per_sale' => clean_number($params['company_average_revenue_per_sale']),
            'work_week_left_for_the_year' => clean_number($params['work_week_left_for_the_year']),
            'work_month_left_for_the_year' => clean_number($params['work_month_left_for_the_year']),
            'company_sales_needed_per_week' => clean_number($params['company_sales_needed_per_week']),
            'company_sales_needed_per_month' => clean_number($params['company_sales_needed_per_month']),
            'active_company_sales_rep' => clean_number($params['active_company_sales_rep']),
            'average_annual_sales_per_sales_reps' => clean_number($params['average_annual_sales_per_sales_reps']),
            'new_hire_rentention_rate' => clean_number($params['new_hire_rentention_rate']),
            'total_sales_reps_needed' => clean_number($params['total_sales_reps_needed']),
            'new_hire_needed' => clean_number($params['new_hire_needed']),
            ...
            foreach ($params['kpi_target_sale'] as $kpi_target_sale_type => $values) {
                foreach ($values as $kpi_group_id => $value) {
                    $kpi_target_data[] = [
                        ...
                        'target_value' => clean_number($value),
                        'created_at' => Carbon::now(),
                    ];
                }
            }
