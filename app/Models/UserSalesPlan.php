    ...
    */
    ...
    public static function addUserSalesPlan($user_id,$params)
    {
        if( !empty($params['revenue_per_sale_amount']) && $params['user_annual_income_target'] )
        {
            $record = self::create([
                'user_id'                      => $user_id,
                'revenue_per_sale_amount'      => round($params['revenue_per_sale_amount']),
                'user_annual_income_target'    => round($params['user_annual_income_target']),
                'total_annual_sales_needed'    => round($params['total_annual_sales_needed']),
                'total_work_week_left_to_sell' => round($params['total_work_week_left_to_sell']),
                'average_commission_per_sale'  => round($params['average_commission_per_sale']),
                'total_contracts_needed'       => round($params['total_contracts_needed']),
                'total_work_month_left_to_sell'=> round($params['total_work_month_left_to_sell']),
